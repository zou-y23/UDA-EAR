    ...
    def _construct_loader(self):
        ...
        with g_pathmgr.open(path_to_file, "r") as f:
            for clip_idx, path_label in enumerate(f.read().splitlines()):
                ...
                path, label1, label2 = path_label.split(
                ...
                for idx in range(self._num_clips):
                    ...
                    self._labels2.append(int(label2))
        ...
        for i_try in range(self._num_retries):
            ...
            if self.aug:
                if self.cfg.AUG.NUM_SAMPLE > 1:
                    ...
                    return frame_list, label1_list, label2_list, index_list, {}
            ...
            return frames, label1, label2, index, {}
        else:
            raise RuntimeError(
