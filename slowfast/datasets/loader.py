...
def multiple_samples_collate(batch, fold=False):
    ...
    """
    inputs, labels1, labels2, video_idx, extra_data = zip(*batch)
    ...
    inputs, labels1, labels2, video_idx, extra_data = (
    ...
    if fold:
        return [inputs], labels1, labels2, video_idx, extra_data
    else:
        return inputs, labels1, labels2, video_idx, extra_data
...
def detection_collate(batch):
    ...
    labels1 = torch.tensor(np.concatenate(labels1, axis=0)).float()
    labels2 = torch.tensor(np.concatenate(labels2, axis=0)).float()
    ...
    return inputs, labels1, labels2, video_idx, collated_extra_data
