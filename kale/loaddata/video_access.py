...
class VideoDataset(Enum):
    ...
    def get_source_target(source: "VideoDataset", target: "VideoDataset", seed, params):
        ...
        num_classes_n = min(class_numbers_n[source], class_numbers_n[target])
        num_classes_v = min(class_numbers_v[source], class_numbers_v[target])
...
class VideoDatasetAccess(DatasetAccess):
    ...
    def __init__(
        self, data_path, train_list, test_list, image_modality, frames_per_segment, n_classes_n, n_classes_v, transform_kind, seed
    ):
        super().__init__(n_classes_n, n_classes_v)
...
class EPICDatasetAccess(VideoDatasetAccess):
    ...
    def get_train(self):
        return EPIC(
            ...
            dataset_split="train",
            n_classes_n=self._n_classes_n,
            n_classes_v=self._n_classes_v,
        )
