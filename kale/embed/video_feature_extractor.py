...
from kale.embed.video_uniformer import *

def get_video_feat_extractor(model_name, image_modality, attention, num_classes_n, num_classes_v, cfg):
    """
    ...
    model_list = ["I3D", "R3D_18", "MC3_18", "R2PLUS1D_18", "UNIFORMER"]
