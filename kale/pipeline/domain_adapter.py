...
class BaseAdaptTrainer(pl.LightningModule):
    ...
    def __init__(
        ...
        self.classifier_n = task_classifier_n
        self.classifier_v = task_classifier_v
...
class BaseDANNLike(BaseAdaptTrainer):
    ...
    def __init__(
        ...
        **base_params,
        ...
        super().__init__(dataset, feature_extractor, task_classifier_n, task_classifier_v, **base_params)
    ...
    def validation_epoch_end(self, outputs):
        metrics_to_log = (
            ...
            "val_domain_acc",
            #"val_source_domain_acc_n",
            #"val_target_domain_acc_n",
            #"val_domain_acc_n",
            "val_source_acc_v",
            "val_target_acc_v",
            #"val_source_domain_acc_v",
            #"val_target_domain_acc_v",
            #"val_domain_acc_v",
        )
        return self._validation_epoch_end(outputs, metrics_to_log)
...
class DANNTrainer(BaseDANNLike):
    ...
    def __init__(
        self, dataset, feature_extractor, task_classifier_n, task_classifier_v, critic, method=None, **base_params,
    ):
        super().__init__(dataset, feature_extractor, task_classifier_n, task_classifier_v, critic, **base_params)
