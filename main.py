...
class PrintEpochCallback(Callback):
    def on_epoch_start(self, trainer, pl_module):
        print(f"Epoch {trainer.current_epoch + 1} starting.")
...
def main():
    ...
    source, target, num_classes_n, num_classes_v = VideoDataset.get_source_target(
    ...
    for i in range(0, cfg.DATASET.NUM_REPEAT):
        ...
        model, train_params = get_model(cfg, dataset, num_classes_n, num_classes_v)
        ...
        # last_checkpoint_file = '/data/ZouYiShan/CTAN-240522/CTAN/logs/EPIC-d12d2-dann/seed2020/version_4/checkpoints/epoch=5-step=558-val_loss=5.3661.ckpt'
        ...
        trainer = pl.Trainer(
            ...
            callbacks=[lr_monitor, checkpoint_callback, progress_bar, print_epoch_callback],
